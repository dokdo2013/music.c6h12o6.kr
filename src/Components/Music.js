          ...
          <Flex mt="1" justifyContent="space-between" alignContent="center">
            ...
            >
              <Flex alignItems="center">
                <Badge
                  colorScheme={apiData.category_color}
                  size="10"
                  fontSize="10"
                  mr="1"
                >
                ...
                {apiData.music_comment === null ||
                apiData.music_comment === "" ? (
                  ""
                ) : (
                  <span>
                    <Tooltip
                      hasArrow
                      label={apiData.music_comment}
                      bg="gray.300"
                      color="black"
                      key={apiData.idx}
                    >
          ...
          {data.isLogin && (
            <Flex justifyContent="space-between" alignContent="center" mt="2">
              <Button
                ...
                mr="0.5"
                onClick={() => {
                  data.setEditTarget(apiData.idx);
                  data.EditMusicModalOnOpen();
                }}
                isFullWidth
              >
                수정
              ...
              <Button
                ...
                ml="0.5"
                onClick={() => {
                  data.setDeleteTarget(apiData.idx);
                  data.setDeleteIsOpen(true);
                }}
              >
                <FaTrashAlt />
              </Button>
