              ...
              <TabPanels>
                ...
                <TabPanel>
                  <Alert status="warning" fontSize="sm">
                    ...
                    사용해보실 수 있습니다. 실험실 기능은 불안정하여 서비스
                    오류를 유발할 수 있으며, 예고없이 추가/삭제 될 수 있습니다.
                  </Alert>
                ...
                <TabPanel>
                  ...
                  <Text fontSize="sm">
                    ...
                    이용자의 추가정보를 이용자의 컴퓨터에서 찾아 접속에 따른
                    성명 등의 추가 입력 없이 서비스를 제공할 수 있습니다. 쿠키는
                    이용자의 컴퓨터는 식별하지만 이용자를 개인적으로 식별하지는
                    않습니다.
                    <br />
                    <br />
                    또한 이용자는 쿠키에 대한 선택권이 있습니다. 웹브라우저
                    상단의 도구 - 인터넷옵션 탭(option tab)에서 모든 쿠키를 다
                    받아들이거나, 쿠키가 설치될 때 통지를 보내도록 하거나,
                    아니면 모든 쿠키를 거부할 수 있는 선택권을 가질 수 있습니다.
                    단, 쿠키의 저장을 거부하실 경우 본 웹사이트에서 제공하는
                    일부 서비스는 이용하실 수 없게 됩니다.
                  </Text>
                  <br />
                  <Text fontSize="lg" fontWeight="semibold">
                    쿠키(cookie) 운용 목적
                  ...
                  <Text fontSize="sm">
                    ...
                    웹사이트가 쿠키를 통해 수집하는 정보는 소셜 로그인 회원 ID와
                    관리자 ID에 한하며, 그 외의 다른 정보는 수집하지 않습니다.
                    본 웹사이트가 쿠키(cookie)를 통해 수집한 회원 ID는 다음의
                    목적을 위해 사용됩니다.
                    <br />
                    <br />
                    - 개인의 관심 분야에 따라 차별화된 정보를 제공
                    <br />
                    - 본 웹사이트의 회원 서비스 이용을 위한 로그인시 인증
                    <br />
                    ...
                    쿠키(Cookie)를 통하여 본 웹사이트 이용자의 행태정보를
                    수집하게 되며, 이 경우 이용자 개인을 식별할 수 없는
                    비식별정보 만이 수집됩니다. 그럼에도 이용자는 Google
                    애널리틱스 차단 브라우저 부가기능의
                    설치(https://tools.google.com/dlpage/gaoptout) 또는
                    웹브라우저의 쿠키 설정 거부를 통해 구글 애널리틱스 이용을
                    거부할 수 있습니다.
                    <br />
                    <br />
                    그리고, 이와 같이 수집된 비식별 행태정보는 구글(Google)의
                    구글 애드워즈 서비스를 통하여 온라인 광고 목적으로 사용될 수
                    있습니다.
                  </Text>
                </TabPanel>
                <TabPanel>
                  ...
                  <br />
                  <Text fontSize="sm">
                    본 프로젝트는 오픈소스로 제작되었으며 GNU GPL v3.0
                    라이센스를 따릅니다. 라이센스 규정 위반시 관련 법령에 의해
                    처벌될 수 있습니다. 소스코드는{" "}
                    <Link
                      href="https://github.com/dokdo2013/music.c6h12o6.kr"
                      color="purple.300"
                      isExternal
                    >
                      깃허브(새 창)
                  ...
                  <Text fontSize="sm">
                    Copyrights ©{" "}
                    <span style={{ fontWeight: "bold" }}>music.c6h12o6.kr</span>
                    . All Rights Reserved.
                  </Text>
                  <Text fontSize="sm">
                    TWITCH, the TWITCH Logo, the Glitch Logo, and/or TWITCHTV
                    are trademarks of Twitch Interactive, Inc. or its
                    affiliates.
                  </Text>
                  <Text fontSize="sm">
                    앨범아트의 저작권 일체는 음원 소유자에게 있습니다.
                  </Text>
                  <br />
