              ...
              <TabPanels>
                <TabPanel>
                  ...
                  <Flex flexDirection="column">
                    <FormControl mb="3">
                      <FormLabel htmlFor='nowPassword'>현재 비밀번호 *</FormLabel>
                      <InputGroup size='md'>
                        <Input
                          pr='4.5rem'
                          id="nowPassword"
                        ...
                        <InputRightElement width='4.5rem'>
                          <Button h='1.75rem' size='sm' onClick={nowHandleClick}>
                            {nowShow ? '가리기' : '보이기'}
                          </Button>
                        </InputRightElement>
                      </InputGroup>
                    ...
                    <FormControl mb="3">
                      <FormLabel htmlFor='newPassword'>새로운 비밀번호 *</FormLabel>
                      <InputGroup size='md'>
                        <Input
                          pr='4.5rem'
                          id="newPassword"
                        ...
                        />
                        <InputRightElement width='4.5rem'>
                          <Button h='1.75rem' size='sm' onClick={newHandleClick}>
                            {newShow ? '가리기' : '보이기'}
                          </Button>
                        </InputRightElement>
                      </InputGroup>
                      <FormHelperText>비밀번호 규칙 : 영어, 숫자를 포함해 8자 이상 (대소문자 구분)</FormHelperText>
                    </FormControl>

                    <Button colorScheme="purple" isFullWidth onClick={changePassword}>변경</Button>
                  </Flex>
